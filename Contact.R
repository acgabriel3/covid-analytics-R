...
setwd("~/Dropbox (InteligCooperativa)/Projetos de Trabalho/20-03 Desafio COVid 19/Network")

#Lendo arquivos externos
s <- read.csv("edgelist.csv", sep = ";" , header=TRUE,
              colClasses=c("pessoa"="character"))
p <- read.csv("confsus.csv", sep = ";" , header=TRUE, 
